...
## Flare projectile from flare gun
## Flies through air, bounces, and burns like a regular flare
...
func _ready() -> void:
	...
	# Enable bouncing with physics material
	var physics_mat = PhysicsMaterial.new()
	physics_mat.bounce = 0.6
	...
	# Create 3D burn sound (same as thrown flare)
	...
	print("Flare projectile created, will burn for ", burn_time_remaining, " seconds")
